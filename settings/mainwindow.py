...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_22.setGeometry(QtCore.QRect(400, 260, 151, 31))
        self.label_22.setObjectName("label_22")
        self.keyopencloseComboBox_3 = QtWidgets.QComboBox(self.tab_4)
        self.keyopencloseComboBox_3.setGeometry(QtCore.QRect(550, 260, 141, 41))
        self.keyopencloseComboBox_3.setObjectName("keyopencloseComboBox_3")
        self.keyopencloseComboBox_3.addItem("")
        self.keyopencloseComboBox_3.addItem("")
        self.keyopencloseComboBox_3.addItem("")
        self.keyopencloseComboBox_3.addItem("")
        self.keyopencloseComboBox_3.addItem("")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_22.setText(_translate("MainWindow", "Triggerkey"))
        self.keyopencloseComboBox_3.setToolTip(_translate("MainWindow", "Disables all Cheat Options. Keeps the cheat running."))
        self.keyopencloseComboBox_3.setItemText(0, _translate("MainWindow", "None"))
        self.keyopencloseComboBox_3.setItemText(1, _translate("MainWindow", "Insert"))
        self.keyopencloseComboBox_3.setItemText(2, _translate("MainWindow", "Delete"))
        self.keyopencloseComboBox_3.setItemText(3, _translate("MainWindow", "F1"))
        self.keyopencloseComboBox_3.setItemText(4, _translate("MainWindow", "F2"))
        self.keyopencloseComboBox_3.setItemText(5, _translate("MainWindow", "F3"))
        self.keyopencloseComboBox_3.setItemText(6, _translate("MainWindow", "F4"))
        self.keyopencloseComboBox_3.setItemText(7, _translate("MainWindow", "F5"))
        self.keyopencloseComboBox_3.setItemText(8, _translate("MainWindow", "F6"))
        self.keyopencloseComboBox_3.setItemText(9, _translate("MainWindow", "F7"))
        self.keyopencloseComboBox_3.setItemText(10, _translate("MainWindow", "F8"))
        self.keyopencloseComboBox_3.setItemText(11, _translate("MainWindow", "F9"))
        self.keyopencloseComboBox_3.setItemText(12, _translate("MainWindow", "F10"))
        self.keyopencloseComboBox_3.setItemText(13, _translate("MainWindow", "F11"))
